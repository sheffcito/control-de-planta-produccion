# control de produccion v5.0



## Template variables

* `control_de_produccion_v50` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `control de produccion v5.0` - executable or bundle name on disk.
* `control de produccion v5.0` - display name shown in window titles and about app dialogs.
